...
public struct ThemeSetting: Codable {
    ...
    class AttributesContainer: Codable {
        ...
        func encode(to encoder: Encoder) throws {
            ...
            var actionThemeAttribute: [ActionThemeAttribute] = []
            ...
            for attribute in attributes {
                if let attribute = attribute as? LineHeightThemeAttribute {
                    ...
                    actionThemeAttribute.append(attribute)
            ...
            try container.encode(actionThemeAttribute, forKey: .actionThemeAttribute)
        ...
        required init(from decoder: Decoder) throws {
            ...
            attributes.append(try container.decode(LineHeightThemeAttribute.self, forKey: .lineHeightThemeAttribute))
            attributes.append(try container.decode(TailIndentThemeAttribute.self, forKey: .tailIndentThemeAttribute))
            attributes.append(try container.decode(TabStopsThemeAttribute.self, forKey: .tabStopsThemeAttribute))
            attributes.append(try container.decode(ParagraphSpacingAfterThemeAttribute.self, forKey: .paragraphSpacingAfterThemeAttribute))
            attributes.append(try container.decode(TextAlignmentThemeAttribute.self, forKey: .textAlignmentThemeAttribute))
            attributes.append(try container.decode(HeadIndentThemeAttribute.self, forKey: .headIndentThemeAttribute))
            attributes.append(try container.decode(FirstLineHeadIndentThemeAttribute.self, forKey: .firstLineHeadIndentThemeAttribute))
            attributes.append(try container.decode(TextBlockThemeAttribute.self, forKey: .textBlockThemeAttribute))
            attributes.append(try container.decode(ParagraphSpacingBeforeThemeAttribute.self, forKey: .paragraphSpacingBeforeThemeAttribute))
            attributes.append(try container.decode(DefaultTabIntervalThemeAttribute.self, forKey: .defaultTabIntervalThemeAttribute))
            attributes.append(try container.decode(ItalicThemeAttribute.self, forKey: .italicThemeAttribute))
            attributes.append(try container.decode(KernThemeAttribute.self, forKey: .kernThemeAttribute))
            attributes.append(try container.decode(UnderlineThemeAttribute.self, forKey: .underlineThemeAttribute))
            attributes.append(try container.decode(BoldThemeAttribute.self, forKey: .boldThemeAttribute))
            attributes.append(try container.decode(ActionThemeAttribute.self, forKey: .actionThemeAttribute))
            attributes.append(try container.decode(BackgroundColorThemeAttribute.self, forKey: .backgroundColorThemeAttribute))
            attributes.append(try container.decode(ColorThemeAttribute.self, forKey: .colorThemeAttribute))
            attributes.append(try container.decode(HiddenThemeAttribute.self, forKey: .hiddenThemeAttribute))
            attributes.append(try container.decode(LigatureThemeAttribute.self, forKey: .ligatureThemeAttribute))
            attributes.append(try container.decode(FontThemeAttribute.self, forKey: .fontThemeAttribute))
