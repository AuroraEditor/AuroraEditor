...
final class ProjectCommitHistory: Equatable, Identifiable, TabBarItemRepresentable, ObservableObject, Sendable {
    /// Logger
    ...
    /// The tab ID
    nonisolated public var tabID: TabBarItemID {
    ...
    func reloadProjectHistory() throws {
        ...
        let projectHistory = try GitLog().getCommits(
